<section class="card border-0 shadow-sm mb-4" aria-labelledby="page-title">
    <div class="card-body p-4 p-md-5">
        ...
        <p class="text-secondary mb-0">Submit real validation outcomes for predefined IDN templates and auto-classify severity (high/medium/low).</p>
    </div>
</section>
...
<section class="card border-0 shadow-sm" aria-labelledby="submit-title">
    <div class="card-body p-4">
        <h2 id="submit-title" class="h5 mb-3">New submission</h2>
        <form method="post" action="/submissions" class="row g-3" novalidate>
            ...
            <div class="col-12">
                <h3 class="h6 mt-2">Template results</h3>
            ...
            <div class="col-12">
                <button id="submit-button" class="btn btn-primary" type="submit">Publish submission</button>
            </div>
        </form>
    </div>
</section>

<section class="card border-0 shadow-sm mt-4" aria-labelledby="history-title">
    <div class="card-body p-4">
        <h2 id="history-title" class="h5">Latest public submissions</h2>
        <div class="table-responsive">
            <table class="table table-striped mb-0">
                ...
                <?php foreach ($history as $item): ?>
                    <tr>
                        <td><?= htmlspecialchars((string)$item['software_name'], ENT_QUOTES, 'UTF-8') ?></td>

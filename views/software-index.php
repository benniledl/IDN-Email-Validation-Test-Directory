                ...
                <article class="directory-plugin-card">
                    <div class="directory-plugin-icon-wrap">
                        <?php if (!empty($item['plugin_icon_url'])): ?>
                            <img class="directory-plugin-icon" src="<?= htmlspecialchars((string)$item['plugin_icon_url'], ENT_QUOTES, 'UTF-8') ?>"
                                <?php if (!empty($item['plugin_icon_2x_url'])): ?>srcset="<?= htmlspecialchars((string)$item['plugin_icon_url'], ENT_QUOTES, 'UTF-8') ?>, <?= htmlspecialchars((string)$item['plugin_icon_2x_url'], ENT_QUOTES, 'UTF-8') ?> 2x"<?php endif; ?>
                                alt="<?= htmlspecialchars($decodedName, ENT_QUOTES, 'UTF-8') ?> icon" loading="lazy">
                        <?php else: ?>
                    ...
                    <div class="directory-plugin-body">
                        ...
                        <div class="directory-plugin-meta">
                            <?php if (!empty($item['plugin_author'])): ?><span>👤 <?= htmlspecialchars((string)$item['plugin_author'], ENT_QUOTES, 'UTF-8') ?></span><?php endif; ?>
